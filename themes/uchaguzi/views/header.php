...
<body id="page" class="withvernav">
    ...
    <header id="global-header" class="cf">
		<hgroup class="col_4 cf">
			<h1 class="logo"><a href="<?php echo url::site();?>"><img src="<?php echo url::file_loc('img'); ?>themes/uchaguzi/images/logo-uchaguzi-malawi.png" /><span class="nodisplay"><?php echo $site_name; ?></span></a></h1>
